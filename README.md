...
- 供应商：`OPENAI_BASE_URL=http://openai.beefsms.com:38888/v1`，provider id `beefsms`，`modelProviderOrder: [beefsms]`。模型 `happy/kimi-k3` / `happy/glm-5.3` / `happy/qwen-3.8-fast` / `deepseek-flash`。`modelRoles.vision` 必须是 `beefsms/deepseek-flash`。
